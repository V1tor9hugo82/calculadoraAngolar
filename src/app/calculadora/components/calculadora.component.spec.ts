...
describe('CalculadoraComponent', () => {
  ...
  it('deve garantir que 3 + 2 = 5', () => {
    ...
    let btmCalcular = fixture.debugElement.query(By.css('#btnCalcular'));
    let display = fixture.debugElement.query(By.css('#btndisplay'));
    ...
    btmCalcular.triggerEventHandler('click', null);
    fixture.detectChanges();
